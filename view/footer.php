            ...
            <div class="container">
                ...
                <ul>
                    <li style="list-style:none;">
                       <img src="e2.jpg" alt="" width="20%" height="200px" style="margin-left: 500px;">
                          <div><p style="margin: 30px;"> e-commerce website is one that allows people to buy and sell physical goods, services, and digital products over the internet rather than at a brick-and-mortar location. Through an e-commerce website, a business can process orders, accept payments, manage shipping and logistics, and provide customer service.</p></div>
